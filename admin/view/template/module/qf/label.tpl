          ...
          <tbody>
            <?php foreach($labels as $label) { ?>
              <tr class="label-box">
                ...
                <td class="left"><input type="text" name="name" value="<?php echo $label['name']; ?>"></td>
                <td class="left"><input type="text" name="text" value="<?php echo $label['text']; ?>"></td>
                <td class="left"><input type="text" name="text_admin" value="<?php echo $label['text_admin']; ?>"></td>
                <td class="left"><input type="text" name="placeholder" value="<?php echo $label['placeholder']; ?>" <?php if($label['type']==2){ ?> disabled<?php } ?>></td>
                <td class="left"><input type="text" name="pattern" value="<?php echo $label['pattern']; ?>"<?php if($label['type']==2){ ?> disabled<?php } ?>></td>
                <td class="left"><input type="number" name="min" value="<?php echo $label['min']; ?>" class="min-max"<?php if($label['type']==2){ ?> title="<?php echo $text_label_checkbox_min; ?>"<?php } ?>>/<input type="number" name="max" value="<?php echo $label['max']; ?>" class="min-max" <?php if($label['type']==2){ ?> disabled<?php } ?>></td>
                <td class="left"><input type="text" name="text_error" value="<?php echo $label['text_error']; ?>"<?php if($label['type']==2){ ?> title="<?php echo $text_label_checkbox_error_text; ?>"<?php } ?>></td>
      ...
      $.ajax({
        ...
        success: function(json) {
          if (json.hasOwnProperty('success')) {
            var html = '<tr class="label-box"> <td class="left"> <input type="hidden" name="id" value="'+json.success.id+'"> <input type="hidden" name="type" value="'+type+'"> '+typeText+' </td> <td class="left"><input type="text" name="name" value="'+json.success.name+'"></td> <td class="left"><input type="text" name="text" value="'+json.success.id+'"></td> <td class="left"><input type="text" name="text_admin" value="'+json.success.id+'"></td> <td class="left"><input type="text" name="placeholder" value=""'+(type==2?' disabled':'')+'></td> <td class="left"><input type="text" name="pattern" value=""'+(type==2?' disabled':'')+'></td> <td class="left"><input type="number" name="min" value="-1" class="min-max"'+(type==2?' title="<?php echo $text_label_checkbox_min; ?>"':'')+'>/<input type="number" name="max" value="-1" class="min-max"'+(type==2?' disabled':'')+'></td> <td class="left"><input type="text" name="text_error" value=""'+(type==2?' title="<?php echo $text_label_checkbox_error_text; ?>"':'')+'></td> <td class="right"><a class="button update-label" role="button"><?php echo $btn_refresh; ?></a>&nbsp;<a class="button delete-label" role="button"><?php echo $btn_delete; ?></a></td> </tr>';
