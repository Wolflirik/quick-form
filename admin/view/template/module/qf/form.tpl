                ...
                <div id="tabs-block-<?php echo $form['id']; ?>-config">
                  <table class="form config">
                    <tbody>
                      ...
                      <tr>
                        <td class="left">
                          <label for="qf-<?php echo $form['id']; ?>-email"><?php echo $text_form_email; ?></label>
                        </td>
                        <td class="left">
                          <input class="machine-name" id="qf-<?php echo $form['id']; ?>-email" type="text" name="email" value="<?php echo $form['email']; ?>"/>
                        </td>
                      </tr>
                      <tr>
                        <td class="left">
                          <label for="qf-<?php echo $form['id']; ?>-submit"><?php echo $text_form_submit; ?></label>
                        </td>
                        <td class="left">
                          <input class="machine-name" id="qf-<?php echo $form['id']; ?>-submit" type="text" name="submit" value="<?php echo $form['submit']; ?>"/>
                        </td>
                      </tr>
                    </tbody>
                  </table>
